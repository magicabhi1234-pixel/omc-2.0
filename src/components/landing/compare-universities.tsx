          ...
          <table className="w-full">
            ...
            <thead className="bg-[#0B3B68] text-white">
              <tr>
                ...
                <th className="p-5 text-center">NAAC Grade</th>
                <th className="p-5 text-center">Placement</th>
                <th className="p-5 text-center">EMI</th>
              ...
              {universities.map((item) => (
                ...
                >
                  ...
                  <td className="p-5 text-center">
                    <button
                      onClick={openPopup}
                      className="cursor-pointer rounded-xl bg-[#F47C45] px-5 py-2 text-white transition hover:opacity-90"
                    >
                      Apply Now
                    </button>
                  </td>
        ...
        <div className="grid gap-5 lg:hidden">
          ...
          {universities.map((item) => (
            ...
            >
              ...
              <button
                onClick={openPopup}
                className="mt-5 w-full cursor-pointer rounded-xl bg-[#F47C45] py-3 text-white"
              >
                Apply Now
              </button>
