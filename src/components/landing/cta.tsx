      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#0B3B68] via-[#123f6d] to-[#0F172A] py-24 text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 text-center">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-5">
            ...
            <button className="cursor-pointer rounded-xl bg-[#F47C45] px-10 py-4 text-lg font-semibold text-white transition hover:scale-105">
              Apply Now
            </button>
  
            <button className="cursor-pointer rounded-xl border border-white px-10 py-4 text-lg font-semibold text-white transition hover:bg-white hover:text-[#0B3B68]">
