        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-5 flex flex-wrap gap-4 text-sm font-medium text-slate-700">
              <span><span aria-hidden="true">✓</span> 50+ Universities</span>
              <span><span aria-hidden="true">✓</span> AI Comparison</span>
              <span><span aria-hidden="true">✓</span> UGC Approved</span>
              <span><span aria-hidden="true">✓</span> Free Counselling</span>
            </div>

            {/* CTA */}
            <div className="mt-7 flex flex-wrap gap-4">
              <OpenPopupButton className="cursor-pointer rounded-xl bg-[#0B3B68] px-6 py-3 font-semibold text-white transition hover:opacity-90">
                Explore Universities
              </OpenPopupButton>

              <OpenPopupButton className="cursor-pointer rounded-xl border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-800 transition hover:bg-slate-50">
                Compare Colleges
              </OpenPopupButton>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 md:grid-cols-4">
              ...
              <div className="rounded-xl border bg-white p-4 shadow-sm">
                <p className="text-2xl font-bold text-[#0B3B68]">
                  50+
                </p>
